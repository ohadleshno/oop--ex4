...
public class Flower extends GameObject {
    ...
    public Flower(Vector2 flowerTopLeftRight) {
        ...
        new ScheduledTask(this, new Random().nextFloat(0,0.5f), false, () ->{
            new Transition<Float>(this, this.renderer()::setRenderableAngle, 0f, 120f, Transition.CUBIC_INTERPOLATOR_FLOAT, cycleLength, Transition.TransitionType.TRANSITION_BACK_AND_FORTH, null);
            new Transition<Vector2>(this, this::setDimensions, FLOWER_SIZE, FLOWER_SIZE.mult(1.4f), Transition.CUBIC_INTERPOLATOR_VECTOR, cycleLength, Transition.TransitionType.TRANSITION_BACK_AND_FORTH, null);
        });
    }
}
